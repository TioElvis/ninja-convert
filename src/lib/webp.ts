export interface ConvertWebpToPngProps {
  file: File;
}

export function convertWebpToPng({
  file,
}: ConvertWebpToPngProps): Promise<File> {
  return new Promise((resolve, reject) => {
    ...
    if (file.type !== "image/webp") {
      return reject(new Error("File must be a WEBP image."));
    }
...
export interface ConvertWebpToJpgJpegProps {
  file: File;
  extension: "jpg" | "jpeg";
}

export function convertWebpToJpgJpeg({
  file,
  extension,
}: ConvertWebpToJpgJpegProps): Promise<File> {
  return new Promise((resolve, reject) => {
    if (!(file instanceof File)) {
      return reject(new Error("File must be a valid File object."));
    }
...
export interface ConvertWebpToAvifProps {
  file: File;
}

export function convertWebpToAvif({
  file,
}: ConvertWebpToAvifProps): Promise<File> {
  return new Promise((resolve, reject) => {
    if (!(file instanceof File)) {
      return reject(new Error("File must be a valid File object."));
    }
